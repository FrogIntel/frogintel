.class public Lcom/teragence/client/f;
...
.method public constructor <init>(Landroid/content/Context;Ljava/net/InetAddress;Z)V
    ...
    iput-object p1, p0, Lcom/teragence/client/f;->a:Landroid/content/Context;

    iput-object p2, p0, Lcom/teragence/client/f;->b:Ljava/net/InetAddress;

    iput-boolean p3, p0, Lcom/teragence/client/f;->c:Z
...
.method public a(I)Ljava/net/DatagramSocket;
    ...
    iget-object v0, p0, Lcom/teragence/client/f;->a:Landroid/content/Context;

    iget-object v1, p0, Lcom/teragence/client/f;->b:Ljava/net/InetAddress;

    invoke-static {v0, v1}, Lcom/teragence/library/v0;->c(Landroid/content/Context;Ljava/net/InetAddress;)Z

    move-result v0

    if-nez v0, :cond_1

    iget-boolean v0, p0, Lcom/teragence/client/f;->c:Z
